    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <input defaultValue={todo.id} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} /> <br /><br />
            ...
            <a href={`${API}/${todo.id}/description/${todo.description}`} className="btn btn-primary">
                Update Todo Description</a>  <br />
            <input defaultChecked={todo.completed} className="w-50 float-start" type="checkbox"
